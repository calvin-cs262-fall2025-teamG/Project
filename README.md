...
# Features
* A user must sign in using their Calvin email. A code is sent to their email so they don't need a password.
* Borrowers can chat with lenders to discuss where to pick up / return items.
* Borrowers can bookmark items they might want to borrow later.
